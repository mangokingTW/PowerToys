"""Recording support for Command Palette bookmark placeholder verification.

Off unless `WINTEGRATE_RECORD=1`. Needs the video extra:
...
class _Recording:
    ...
    def begin(self) -> None:
        ...
        output = OUTPUT_DIR / f"reproduction-cmdpal-bookmark-placeholder-{arch}.mp4"
